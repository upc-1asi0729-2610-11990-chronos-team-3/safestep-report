...
<table align="center" border="1" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif;">
    ...
    <tbody>
        <!-- EP08 - Landing page pública (US47 a US56) -->
        <tr>
        ...
        <!-- EP02 - Dashboard principal (US06 a US09) -->
        <tr>
        ...
        <!-- EP03 - Simulaciones médicas (US10 a US17) -->
        <tr>
        ...
        <!-- EP04 - Progreso y estadísticas (US18 a US22) -->
        <tr>
        ...
        <!-- EP06 - Tienda, carrito y compras (US30 a US43) -->
        <tr>
        ...
        <!-- EP07 - Navegación y experiencia general (US44 a US46) -->
        <tr>
        ...
        <!-- EP01 - Identidad, acceso y perfil de usuario (US01 a US05) -->
        <tr>
            <td align="center"><b>PB52</b></td>
